...
public class MovieConstants {
    ...
    public static final String MOST_POPULAR_MOVIES_URL = "http://api.themoviedb.org/3/movie/popular?api_key=" + "ENTER YOUR API KEY HERE";
    public static final String MOST_TOP_RATED_MOVIES_URL = "http://api.themoviedb.org/3/movie/top_rated?api_key=" + "ENTER YOUR API KEY HERE";
